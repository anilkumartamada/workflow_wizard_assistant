...
serve(async (req) => {
  ...
  try {
    const { useCase, workflowText } = await req.json();
    ...
    console.error('Error in evaluate-workflow function:', error);
